Vue.component('up6', {
    ...
    template: '<div name="files-panel" class="post-container">\
        ...
        <div name="post_panel" class="post-container">\
            <span class="btn-t" @click="btnFile_click"><img name="postF" />传文件</span>\
            <span class="btn-t" @click="btnFolder_click"><img name="postFd" />传目录</span>\
            <span class="btn-t" @click="btnPaste_click"><img name="paste" />粘贴</span>\
